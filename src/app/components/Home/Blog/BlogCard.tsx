...
const BlogCard = ({ blog }: Props) => {
  ...
  return (
    <div className="bg-indigo-950 overflow-hidden rounded-md">
      <img
        src={image}
        alt={title}
        width={300}
        height={300}
        className="w-full h-[250px] 0bject-cover"
      />
      <div className="p-4">
        ...
        <div className="mt-4 mb-4 w-full h-[2px] bg-gray-400 opacity-45"></div>
